package com.cedrus.samercsaleh.pingpong.kafka;
...
public class PingPongBallProducer {

    private final TopicConfig topicConfig;
    private final Producer<String, String> producer;

    public PingPongBallProducer(KafkaConfig kafkaConfig, TopicConfig topicConfig){
